...
gulp.task('buildsemantic', function() {
    return (
        gulp.src('assets/semantic/dist/*.css').pipe(gulp.dest('assets/css')),
        gulp.src('assets/semantic/dist/*.js').pipe(gulp.dest('assets/js')),
        gulp
            .src('assets/semantic/src/themes/default/assets/fonts/*')
...
var cssFrontArray = ['./assets/css/semantic.css', './assets/css/main.css']
var cssSPAArray = [
    './assets/css/semantic.css',
    './assets/css/main.css',
    './assets/css/spa.css'
...
gulp.task('minify', function() {
    gulp
        ...
        gulp
            ...
            .pipe(gulp.dest('./assets/css/')),
        gulp
            .src(jsPortfolioArray)
            .pipe(uglify())
            .pipe(concat('bundle-work.min.js'))
            .pipe(gulp.dest('./assets/js/')),
        gulp
            .src(cssPortfolioArray)
...
gulp.task('images', function() {
    gulp
        .src('assets/raw/work/*.{jpg,jpeg,png}')
        ...
        gulp
            .src('assets/raw/blog/*.{jpg,jpeg,png}')
...
gulp.task('favicon', function() {
    gulp.src('./assets/img/logo.png')
        .pipe(
            favicons({
                appName: 'Pick2Heal Labs',
                appDescription: 'Pick2Heal Labs',
                background: '#FFFFFF',
                path: '/assets/favicons/',
                url: 'https://pick2heal.com/',
                display: 'standalone',
